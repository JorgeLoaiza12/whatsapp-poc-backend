...
-- CreateIndex
CREATE UNIQUE INDEX "contacts_tenantId_waPhone_key" ON "contacts"("tenantId", "waPhone");

-- CreateIndex
CREATE UNIQUE INDEX "conversations_tenantId_contactId_phoneNumberId_key" ON "conversations"("tenantId", "contactId", "phoneNumberId");
